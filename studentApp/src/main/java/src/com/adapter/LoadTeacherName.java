...
public class LoadTeacherName extends BaseAdapter{

    private List<Map<String,String>> list;
    private String courseName;
    private LayoutInflater mInflater;

    public LoadTeacherName(List<Map<String, String>> list, String courseName, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = mInflater.inflate(R.layout.addcourseview2,null);
